...
class ConsultantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultant" do
    assert_difference('Consultant.count') do
      post consultants_url, params: { consultant: { client_address: @consultant.client_address, comment: @consultant.comment, consultant_address: @consultant.consultant_address, rating: @consultant.rating } }
    end
  ...
  test "should update consultant" do
    patch consultant_url(@consultant), params: { consultant: { client_address: @consultant.client_address, comment: @consultant.comment, consultant_address: @consultant.consultant_address, rating: @consultant.rating } }
